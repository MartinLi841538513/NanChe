	...
	if ((self=[super initWithFrame:rect])) {
        ...
        for (int i=0; i<pageCount; i++) {
            ...
            if ([imgURL hasPrefix:@"http"]) {
                //网络图片 请使用ego异步图片库
//                [imgView setImageWithURL:[NSURL URLWithString:imgURL] placeholderImage:[UIImage imageNamed:@"logoLoading.jpg"]];
        ...
        pageControl=[[UIPageControl alloc]initWithFrame:CGRectMake(scrollView.frame.size.width-pageControlWidth,scrollView.frame.size.height-pagecontrolHeight, pageControlWidth, pagecontrolHeight)];
